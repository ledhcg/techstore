...
<!-- Mirrored from welly.dexignzone.com/xhtml/reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:38:54 GMT -->
<head>
    <meta charset="utf-8">
							...
							<div id="navpills-1" class="tab-pane active show fade">
								<div class="card review-table">
									<div class="media">
										...
										<img class="mr-3 img-fluid" width="110" src="images/avatar/1.jpg" alt="DexignZone">
										<div class="media-body">
											<h3 class="fs-20 text-black font-w600 mb-3"><a href="email-read.html" class="text-black">Glee Smiley</a>
								...
								<div class="card review-table">
									<div class="media">
										...
										<img class="mr-3 img-fluid" width="110" src="images/avatar/2.jpg" alt="DexignZone">
										<div class="media-body">
											<h3 class="fs-20 text-black font-w600 mb-3"><a href="email-read.html" class="text-black">Alexa Keev</a>
												<span class="star-review ml-sm-3 ml-0 d-sm-inline-block d-block">
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
								...
								<div class="card review-table">
									<div class="media">
										...
										<img class="mr-3 img-fluid" width="110" src="images/avatar/3.jpg" alt="DexignZone">
										<div class="media-body">
											<h3 class="fs-20 text-black font-w600 mb-3"><a href="email-read.html" class="text-black">Ivankov</a>
												<span class="star-review ml-sm-3 ml-0 d-sm-inline-block d-block">
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
								...
								<div class="card review-table">
									<div class="media">
										...
										<img class="mr-3 img-fluid" width="110" src="images/avatar/4.jpg" alt="DexignZone">
										<div class="media-body">
											<h3 class="fs-20 text-black font-w600 mb-3"><a href="email-read.html" class="text-black">Axestoria Jr.</a>
												<span class="star-review ml-sm-3 ml-0 d-sm-inline-block d-block">
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
								...
								<div class="card review-table">
									<div class="media">
										...
										<img class="mr-3 img-fluid" width="110" src="images/avatar/5.jpg" alt="DexignZone">
										<div class="media-body">
											<h3 class="fs-20 text-black font-w600 mb-3"><a href="email-read.html" class="text-black">Kevin Heirn</a>
												<span class="star-review ml-sm-3 ml-0 d-sm-inline-block d-block">
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
													<i class="fa fa-star text-orange"></i>
