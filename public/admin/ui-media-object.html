...
<!-- Mirrored from welly.dexignzone.com/xhtml/ui-media-object.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:39:05 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3 img-fluid " width="60"  src="images/avatar/1.jpg" alt="DexignZone">
                                        <div class="media-body">
                                    ...
                                    <div class="media mt-4">
                                        <img class="mr-3 img-fluid " width="60"  src="images/avatar/7.jpg" alt="DexignZone">
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>
											<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                        </div>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="mr-3 " width="60"  src="images/avatar/2.jpg" alt="DexignZone">
                                        <div class="media-body">
                                            <h5 class="mt-0">Media heading</h5>
                                            <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                            ...
                                            <div class="media mt-4">
                                                <a class="pr-3" href="#">
                                                    <img class="" width="60" src="images/avatar/3.jpg" alt="DexignZone">
                                                </a>
                                                <div class="media-body">
                                                    <h5 class="mt-0">Media heading</h5>
                                                    <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-start mr-3 " width="60"  src="images/avatar/4.jpg" alt="DexignZone">
                                        <div class="media-body">
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-center mr-3 " width="60"  src="images/avatar/5.jpg" alt="DexignZone">
                                        <div class="media-body">
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        <img class="align-self-end mr-3 " width="60"  src="images/avatar/6.jpg" alt="DexignZone">
                                        <div class="media-body">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <div class="media">
                                        ...
                                        <img class="ml-3 " width="60"  src="images/avatar/7.jpg" alt="DexignZone">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="bootstrap-media">
                                    <ul class="list-unstyled">
                                        <li class="media">
                                            <img class="mr-3 " width="60"  src="images/avatar/8.jpg" alt="DexignZone">
                                            <div class="media-body">
                                        ...
                                        <li class="media my-4">
                                            <img class="mr-3 " width="60"  src="images/avatar/1.jpg" alt="DexignZone">
                                            <div class="media-body">
                                                <h5 class="mt-0">List-based media object</h5>
                                                <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus. vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                            </div>
...
<!-- Mirrored from welly.dexignzone.com/xhtml/ui-media-object.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:39:06 GMT -->
</html>