...
<!-- Mirrored from welly.dexignzone.com/xhtml/email-read.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Dec 2020 16:38:55 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="email-left-box generic-width px-0 mb-5">
                                    ...
                                    <div class="mail-list mt-4">
										...
										<a href="javascript:void()" class="list-group-item">
											...
											<span class="badge badge-danger badge-sm text-white float-right">47</span>
                                        </a>
                                        <a href="javascript:void()" class="list-group-item">
                                    ...
                                    <div class="mail-list mt-4">
                                        <a href="email-inbox.html" class="list-group-item"><span class="icon-warning"><i class="fa fa-circle" aria-hidden="true"></i></span>Work</a>
                                        <a href="email-inbox.html" class="list-group-item"><span class="icon-primary"><i class="fa fa-circle" aria-hidden="true"></i></span>Private</a>
                                        <a href="email-inbox.html" class="list-group-item"><span class="icon-success"><i class="fa fa-circle" aria-hidden="true"></i></span>Support</a>
                                        <a href="email-inbox.html" class="list-group-item"><span class="icon-dpink"><i class="fa fa-circle" aria-hidden="true"></i></span>Social</a>
                                    </div>
                                </div>
                                                ...
                                                <div class="read-content">
                                                    <div class="media pt-3 d-sm-flex d-block justify-content-between">
														<div class="clearfix mb-3 d-flex">
															<img class="mr-3 rounded" width="50" alt="image" src="images/avatar/1.jpg">
